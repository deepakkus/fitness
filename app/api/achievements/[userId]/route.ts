...
//             where: {
//                 user_id: BigInt(userIdToFetch), // Fetch achievements for the specified userId
//             },
//             include: {
...
//     } catch (error) {
//         console.error("Error fetching achievements for user:", userIdToFetch, error);
